                                ...
                                <div class="column width-12">
                                    <div class="hero-content-inner left-on-mobile">
                                        <blockquote class="border">
                                            <h1>Proyek yang telah dikerjakan</h1>
                                            <cite style="font-size: 11pt;">"Kami memberikan nilai tambah ke tempat Anda dengan mengatur pencahayaan."</cite>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row grid content-grid-4">
                    <div class="grid-item grid-sizer photography wide">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/noaa-social-dining')}}">
                    ...
                    <div class="grid-item photography">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/adiwana-jeevalokha')}}">
                    ...
                    <div class="grid-item design application">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/harris-hotel-tebet')}}">
                    ...
                    <div class="grid-item design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/sentul-residence')}}">
                    ...
                    <div class="grid-item identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/mixed-used-area-lampung')}}">
                    ...
                    <div class="grid-item portrait design photography">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/the-waterfall-ulaman-retreat')}}">
                    ...
                    <div class="grid-item design">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/harris-hotel-batam')}}">
                    ...
                    <div class="grid-item application">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/villa-ali-agung')}}">
                    ...
                    <div class="grid-item design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/villa-beraban')}}">
                    ...
                    <div class="grid-item design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/karma-residence')}}">
                    ...
                    <div class="grid-item wide design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/harris-hotel-tuban')}}">
                    ...
                    <div class="grid-item design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/tunon-residence')}}">
                    ...
                    <div class="grid-item design identity">
                        <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-opacity="0.9">
                            <a class="overlay-link" href="{{ url('id/projects/ocean-palm')}}">
