                ...
                <div class="footer-top">
                    <div class="row flex">
                        <div class="column width-3">
                            <div class="widget">
                                <h4 class="widget-title weight-light">Tentang Kami</h4>
                                <a href="{{ url('/id.about-us/our-philosophy-story') }}">Filosofi Kami</a><br />
                                <a href="{{ url('/id.about-us/our-philosophy-story#our-story') }}">Cerita Kami</a><br />
                                <a href="{{ url('/id/about-us/our-philosophy-story#official-channels') }}">Saluran Digital Resmi</a><br />
                                <a href="{{ url('/id/about-us/our-studio') }}">Studio Kami</a><br />
                                <p></p>
                            </div>
                        </div>
                        <div class="column width-3">
                            <div class="widget">
                                <h4 class="widget-title weight-light">Proyek-Proyek</h4>
                                <a href="{{ url('/id/projects#completed') }}">Proyek Selesai</a><br />
                                <a href="{{ url('/id/projects#on-going') }}">Proyek Berjalan</a><br />
                                <p></p>
                            </div>
                        </div>
                        <div class="column width-3">
                            <div class="widget">
                                <h4 class="widget-title weight-light">Layanan</h4>
                                <a href="{{ url('/id/services/our-service')}}">Layanan Kami</a><br />
                                <a href="{{ url('/id/services/work-together')}}">Mari Kerjasama</a><br />
                                <a href="{{ url('/id/terms-condition')}}">Syarat & Ketentuan</a><br />
                                <a href="{{ url('/id/privacy-policy')}}">Kebijakan Privasi</a><br />
                                <p></p>
                            </div>
                        </div>
                        <div class="column width-3">
                            <div class="widget">
                                <h4 class="widget-title weight-light">Bahasa</h4>
