    ...
    <div class="section-block pt-70 bkg-blue-binar-body">
        <div class="row">
            ...
            <div class="column width-5 offset-1">
                <p class="mb-50">Lokasi: Petitenget, Bali</p>
            </div>
            <div class="column width-12">
                <hr class="mb-50" />
            </div>
            <div class="column width-4">
                <p class="project-attribute">
                    <span class="project-label">Klien:</span><span class="project-value">PT. BDC Food Specialities Indonesia</span>
                </p>
            </div>
            <div class="column width-4">
                <p class="project-attribute">
                    <span class="project-label">Arsitek:</span><span class="project-value">Arkana</span>
                </p>
            </div>
            <div class="column width-4">
                <p class="project-attribute">
            ...
            <div class="column width-4">
                <p class="project-attribute">
                    <span class="project-label">Photographer:</span><span class="project-value">Eye Instrument Photowerk</span>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="column width-10 offset-1">
                <div class="tabs horizontal center style-2">
                    <ul class="tab-nav">
                        <li class="active">
                            <a href="#tabs-1-pane-1">Filosifi</a>
                        </li>
                        <li>
                            <a href="#tabs-1-pane-2">Hasil</a>
                        </li>
                        <li>
                            <a href="#tabs-1-pane-3">Galeri</a>
                        </li>
                        <li>
                            <a href="#tabs-1-pane-4">Komentar (<span class="fb-comments-count" data-href="http://127.0.0.1:8000/en/projects/noaa-social-dining"></span>) </a>
                        </li>
                    </ul>
                    <div class="tab-panes">
                        <div id="tabs-1-pane-1" class="active animate">
                            <div class="tab-content pt-30">
                                ...
                                <p class="lead">Filosofi</p>
                                <p class="mb-20">
                                    Terletak di Seminyak, NOAA dirancang untuk menjadi 
                                    restoran dengan arsitektur yang menampilkan interior 
                                    yang anggun, atap transparan, 
                                </p>
                                <p class="mb-20">
