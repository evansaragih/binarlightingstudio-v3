            ...
            <div class="column width-5">
                <div class="hero-content split-hero-content">
                    <div class="hero-content-inner left">
                        <p class="color-white">
                            Jl. Padang Griya III No.3,<br />Padang Sambian, West Denpasar<br />
                            Denpasar City, Bali Province
                            80118.
                        </p>
                        <p class="color-grey-light">
                            BINAR A Lighting Studio is an architectural lighting specialist that engage in exterior and facade, interior and landscape lighting. Our work is developed around aesthetics aspect with mainly tailored illumination design that fits well with the premises and the owner’s development aspiration.
                        </p>
                    </div>
                </div>
            </div>
