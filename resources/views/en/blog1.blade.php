      ...
      <div class="column width-12">
        <div class="title-container">
          <div class="title-container-inner">
            <h1 class="inline no-margin-bottom">Single Post Layout</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="sidebar-inner">
          ...
          <div class="widget">
            <div class="box bkg-grey-ultralight mb-50">
              ...
              <p><strong>Starting a new business?</strong> Then Sartre is for you! This multi-purpose template offsers 8 carefully crafted concepts with two variations each, 20+ components and 8+ plugins.
              <p>
            </div>
          </div>
          <div class="widget">
