    ...
    <div class="section-block pt-70 bkg-blue-binar-body">
        <div class="row">
            <div class="column width-6">
                <h1 class="title-medium">Atria Sudirman</h1>
            </div>
            <div class="column width-5 offset-1">
                <p class="mb-50">Location: Sudirman, Jakarta</p>
            </div>
            <div class="column width-12">
                <hr class="mb-50" />
            </div>
        ...
        <div class="row">
            <div class="column width-12">
                <ul>
                    ...
                    <li>
                        <a class="back-to-grid fade-location" href="">Atria Sudirman</a>
                    </li>
                    <li>
