            ...
            <div class="column width-10 offset-1">
                <div class="tabs horizontal center style-2">
                    <ul class="tab-nav">
                        ...
                        <li>
                            <a href="#tabs-1-pane-4">Comments (<span class="fb-comments-count" data-href="http://127.0.0.1:8000/en/projects/harris-hotel-tebet"></span>) </a>
                        </li>
                    </ul>
                    <div class="tab-panes">
                        ...
                        <div id="tabs-1-pane-4">
                            ...
                            <h5>Harris Hotel Tebet</h5>
                                ...
                                <div class="fb-comments" data-href="http://127.0.0.1:8000/en/projects/harris-hotel-tebet" data-width="100%" data-numposts="5" data-mobile="true" data-colorscheme="light" data-link-color="#0cbacf"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="section-block pagination-3 portfolio no-padding-top bkg-blue-binar-body">
        <div class="row">
            <div class="column width-12">
                <ul>
                    <li>
                        <a class="pagination-previous" href="{{ url('/en/projects/adhiwana-jeevalokha') }}"><span class="icon-left-open-mini"></span> Prev</a>
                    </li>
                    <li>
                        <a class="back-to-grid fade-location" href="">Harris Hotel Tebet</a>
                    </li>
                    <li>
                        <a class="pagination-next" href="{{ url('/en/projects/sentul-residence') }}">
