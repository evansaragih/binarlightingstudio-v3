        ...
        <div class="row">
            <div class="column width-12">
                <div class="tm-slider-container content-slider" data-animation="slide" data-width="635" data-height="423" data-scale-under="960">
                    <ul class="tms-slides">
                        <li class="tms-slide" data-image data-as-bkg-image data-force-fit>
                            <img data-src="/assets/img/portofolio/projects/noaa_social_dining/noaa_social_dining-1.jpg" src="images/blank.png" alt="" />
                        </li>
                        <li class="tms-slide" data-image data-as-bkg-image data-force-fit>
                            <img data-src="/assets/img/portofolio/projects/noaa_social_dining/noaa_social_dining-2.jpg" src="images/blank.png" alt="" />
                        </li>
                        <li class="tms-slide" data-image data-as-bkg-image data-force-fit>
                            <img data-src="/assets/img/portofolio/projects/noaa_social_dining/noaa_social_dining-3.jpg" src="images/blank.png" alt="" />
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="tab-content pt-30">
                                ...
                                <div class="row grid content-grid-4">
                                    <div class="grid-item grid-sizer">
                                        <div class="thumbnail">
                                            <a class="overlay-link lightbox-link" data-group="product-gallery" href="images/shop/single/product-3.jpg">
                                                <img src="images/shop/single/product-2.jpg" alt="" />
                                    ...
                                    <div class="grid-item">
                                        <div class="thumbnail">
                                            <a class="overlay-link lightbox-link" data-group="product-gallery" href="images/shop/single/product-3.jpg">
                                                <img src="images/shop/single/product-3.jpg" alt="" />
                                                <span class="overlay-info">
                                                    <span>
                                                        <span>
        ...
        <div class="row">
            <div class="column width-12">
                <ul>
                    ...
                    <li>
                        <a class="back-to-grid fade-location" href="portfolio-three-columns.html">NOAA Social Dining</a>
                    </li>
                    <li>
                        <a class="pagination-next" href="project-style-two.html">
